  ...
  return (
    <div ref={ref} className="relative w-full bg-[#F4F4F5]">
      ...
      {projects.map((project, i) => (
        <div
          key={project.id}
          className="stack-card sticky top-0 min-h-svh w-full flex items-center justify-center px-4 md:px-8 lg:px-12 pb-16 pt-20 lg:pb-24 lg:pt-24 bg-[#F4F4F5]"
        >
                ...
                <div className="flex items-start justify-between gap-4 mb-4 lg:mb-6">
                  ...
                  {project.data.repo && (
                    <a 
                      ...
                      className="w-10 h-10 md:w-12 md:h-12 shrink-0 bg-zinc-900 flex items-center justify-center transition-transform duration-300 hover:translate-x-1 hover:-translate-y-1 mt-1"
                    >
